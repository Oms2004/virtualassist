...
setFrontendImage(URL.createObjectURL(file))
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#020236] flex justify-center items-center flex-col p-[20px] '>
     <IoArrowBack className='absolute top-[30px] left-[30px] text-white w-[25px] h-[25px]' onClick={()=>navigate("/")}/>

      <h1 className='text-white text-[30px] mb-[30px] text-center'>Select Your <span className='text-blue-200'>Assistsant Image</span></h1>
 ...
 <Card image={image6}/> 
 <Card image={image7}/> 
   <div className='w-[70px] h-[140px] lg:w-[150px]  lg:h-[250px] bg-[#030326ec] border-2 border-[#0000ff66] rounded-2xl overflow-hidden hover:shadow-2xl hover:shadow-blue-950 cursor-pointer hover:border-4 hover:border-white flex items-center justify-center  ${selectedImage=="input"?"border-4 border-white shadow-2xl shadow-blue-950":null}' onClick={()=>{
    inputImage.current.click()
    setSelectedImage("input")

}}>
    
  {!frontendImage &&  <RiImageAiLine className='text-white w-[25px] h-[25px]'/>}
